...
func _process(_delta):
	...
	if Global.current_object == "FlowPuzzleNoteBody":
		...
		if Input.is_action_just_pressed("interact") or Input.is_action_just_pressed("left_click"):
			...
			$"../../../MenuPrompt"._set_label_prompt_text("After the *incident*, any electronics stored in this room will be automatically locked away if there are ANY irregularities with water flow. \n \n -Engineering")
